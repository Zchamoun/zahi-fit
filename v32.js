"use strict";
/* Zahi Fit v3.2.0 — Universal Visual PT */
(() => {
  ...
  function photoAssetFor(family, idx){
    // Photographic sequence currently exists for World's Greatest Stretch.
    // Every other mapped exercise uses its own exercise-specific 5-step trainer rendering below.
